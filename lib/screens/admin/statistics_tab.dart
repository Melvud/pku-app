                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: _StatCard(
                        title: 'Отклонено',
                        value: stats['rejectedRecipes']?.toString() ?? '0',
                        icon: Icons.cancel,
                        color: Colors.red,
                        gradient: LinearGradient(
                          begin: Alignment.topLeft,
                ...
                Row(
                  children: [
                    Expanded(
                      child: _StatCard(
                        title: 'Рекомендовано',
                        value: stats['recommendedRecipes']?.toString() ?? '0',
                        icon: Icons.star,
                        color: Colors.indigo,
                        gradient: LinearGradient(
                          begin: Alignment.topLeft,
                ...
                Row(
                  children: [
                    Expanded(
                      child: _StatCard(
                        title: 'Одобрено',
                        value: stats['approvedComments']?.toString() ?? '0',
                        icon: Icons.check_circle_outline,
                        color: Colors.lightGreen,
                        gradient: LinearGradient(
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                          colors: [Colors.lightGreen.shade400, Colors.lightGreen.shade700],
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _StatCard(
                        title: 'На модерации',
                        value: stats['pendingComments']?.toString() ?? '0',
                        icon: Icons.pending,
